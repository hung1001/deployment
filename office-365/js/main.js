...
(function(d) {
    ...
    id("s1").addEventListener("click", e => { e.preventDefault(), showBox("b1") })
    id("s2").addEventListener("click", e => { e.preventDefault(), showBox("b2") })
    id("s3").addEventListener("click", e => { e.preventDefault(), showBox("b3") })
    id("s4").addEventListener("click", e => { e.preventDefault(), showBox("b4") })
    id("s5").addEventListener("click", e => { e.preventDefault(), showBox("b5") })

    var hideBox = id => {
        $("#" + id).slideUp('fast');
    }

    id("h1").addEventListener("click", () => { hideBox("b1") })
    id("h2").addEventListener("click", () => { hideBox("b2") })
    id("h3").addEventListener("click", () => { hideBox("b3") })
    id("h4").addEventListener("click", () => { hideBox("b4") })
    id("h5").addEventListener("click", () => { hideBox("b5") })
    ...
    id("sf1").addEventListener("click", () => { saveTextAsFile(window.editor.getDoc().getValue()) })
